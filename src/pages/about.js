    ...
    return (
        <div className='main '>
            ...
            <div className='container mt-3'>
                <h1>About Me</h1>
                <h2>Introduction</h2>
                <p>Hello, I'm {process.env.NEXT_PUBLIC_siteOwner}, a passionate sketch artist specializing in creating intricate and detailed artworks. With a keen eye for capturing emotions and an innate love for art, I strive to bring stories to life through my sketches.</p>
                <h2>Background</h2>
